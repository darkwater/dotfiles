...
wk.add {
    ...
    { "<leader>ss", shell("cargo sic run", false),                    desc = "Run" },
    { "<leader>sS", shell("cargo sic run --dfu", false),              desc = "Run (dfu)" },
    { "<leader>sr", shell("cargo sic run --release", false),          desc = "Run (release)" },
    { "<leader>sR", shell("cargo sic run --release --dfu", false),    desc = "Run (release, dfu)" },
    { "<leader>sh", shell("cargo sic run --hwtest", false),           desc = "Run (hwtest)" },
    { "<leader>sH", shell("cargo sic run --hwtest --release", false), desc = "Run (hwtest, release)" },
    ...
    { "<leader>stu", shell("cargo sic test unit", false), desc = "Unit tests" },
    { "<leader>se", group = "env" },
